describe('alt.rotas-listener', function () {
  ...
  describe('criação', function() {
    beforeEach(module('alt.rotas-listener', function(AltRotasProvider) {
      AltRotasProvider.rotas = [
        ...
        {icone: '5.jpg', nome: 'Escondido', url: '/lancamentos/escondido', active: false, naoAtivavel: true},
        {
          ...
          subRotas: [
            ...
            {icone: '10.jpg', nome: 'Sub Escondido', url: '/sub-escondido', active: false, naoAtivavel: true}
          ]
        }
      ];
    }));
  ...
  describe('onLoad', function() {
    ...
    it('NÃO deve setar a rota a rota atual nao é ativável', inject(function($controller) {
      spyOn(_location, 'path').and.returnValue('/lancamentos/escondido');
    ...
    it('NÃO deve setar a SUB rota a mesma nao é ativável', inject(function($controller) {
      spyOn(_location, 'path').and.returnValue('/sub-escondido');
      ...
      for (var i = 0; i < _scope.arCtrl.rotas.length; i++) {
        var _subRotas = _scope.arCtrl.rotas[i].subRotas || [];

        for (var j = 0; j < _subRotas.length; j++) {
          expect(_subRotas[j].active).toBe(false);
        }
